          ...
          <div className="space-y-8 text-slate-700">
            <section>
              ...
              <p className="leading-relaxed">
                本規約は、ポイ活なび（以下「当サイト」）が提供するサービスの利用条件を定めるものですユーザーは、当サイトを利用することにより、本規約に同意したものとみなされます
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                当サイトは、アフィリエイトプログラムを利用して収益を得ていますサービスの紹介リンクには、アフィリエイトリンクが含まれる場合があります
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                当サイトに掲載されているコンテンツ（文章、画像、デザイン等）の著作権は、当サイトまたは正当な権利者に帰属します無断での転載、複製は禁止します
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                当サイトは、必要に応じて本規約を変更することができます変更後の規約は、当サイトに掲載した時点で効力を生じるものとします
              </p>
            </section>
            ...
            <section>
              ...
              <p className="leading-relaxed">
                本規約の解釈にあたっては、日本法を準拠法とします当サイトに関して紛争が生じた場合は、当サイト運営者の所在地を管轄する裁判所を専属的合意管轄裁判所とします
              </p>
            </section>
