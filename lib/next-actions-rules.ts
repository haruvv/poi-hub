  ...
  switch (category) {
      ...
      return {
        ...
        items: [
          ...
          },
          {
            title: "ポイ活で投資資金を捻出",
            description:
              "スキマ時間に案件やアンケートでポイントを貯めておけば、その分をそのまま積立投資の原資に回せる。生活とは切り離した“追加のタネ銭”づくりにちょうどいい。",
            href: "/diagnosis/poi-katsu",
            label: "ポイ活を始める",
          },
        ],
    ...
    case "meal":
      return {
        ...
        description:
          "忙しいときは外食やテイクアウトに頼りつつ、平日用には惣菜や冷凍弁当の宅配をうまく組み合わせると、時間とお金のどちらも少しラクになります。外食が多い方は「飲食店でポイントが貯まりやすいクレジットカード」、平日ごはんを宅配に任せたい方は「初回割引や定期便のキャンペーン」を活用すると、ムダなくお得を積み重ねやすくなります。",
        items: [
          {
          ...
          },
          {
            ...
            description:
              "惣菜セットや冷凍弁当の宅配サービスは、初回割引や定期便キャンペーンが組まれていることが多く、上手に選ぶと「コンビニでちょこちょこ買うより安いのにラク」という状態をつくりやすくなる。まずはお試しセットや初回限定プランから試して、家族構成やライフスタイルに合うサービスを拾っていきたい。",
            href: "/diagnosis/meal",
            label: "食事宅配サービスを比較する",
          },
        ],
