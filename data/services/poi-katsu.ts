...
export const poiKatsuServices: Service[] = [
  {
    ...
    // カスタムテキスト（サービス詳細ページ用）
    topCtaMessage: "今なら新規登録だけでボーナスポイントが狙えるキャンペーン実施中。普段のネット利用を登録直後からお得にできます。",
    topCtaSupplement: "キャンペーン内容やポイント付与のタイミングは時期や案件によって異なるため、申し込み前に必ず公式ページの最新条件を確認してください。",
    recommendedFor: [
      "楽天市場やYahoo!ショッピングなど、ネット通販をよく利用していて、買い物前にひと手間かけてでもポイントを増やしたい人",
      "複数のポイントサイトを使い分けるのではなく、メインで使うサイトを1つに決めてシンプルに管理したい人",
      "ポイ活が初めてで、まずは定番サービスから安心してスタートしたい人",
    ],
    precautions: [
      "ポイント交換には最低交換額が設定されているため、少額利用だけだと交換までに時間がかかる場合があります。",
      "ポイント付与の条件や反映までの期間は案件ごとに異なるので、申し込み前に必ず案件詳細ページの条件を確認してください。",
      "退会や会員情報の変更を行う際は、保有ポイントや交換申請中のポイントの扱いを事前に確認してから手続きするようにしましょう。",
    ],
    bottomCtaMessage: "ここまで読んで「使ってみてもいいかも」と感じたら、まずは無料登録だけして、どんな案件があるか軽くのぞいてみてください。",
  },
  {
    id: "poi-2",
    name: "ワラウ",
