...
export const poiKatsuServices: Service[] = [
  {
    ...
    bigImage: [
      {
        html: `<a href="https://px.a8.net/svt/ejp?a8mat=45I5TI+37I44Y+4F8I+64JTD" rel="nofollow">
              <img border="0" width="300" height="250" alt="" src="https://www20.a8.net/svt/bgt?aid=251110134194&wid=001&eno=01&mid=s00000020637001029000&mc=1"></a>
              <img border="0" width="1" height="1" src="https://www13.a8.net/0.gif?a8mat=45I5TI+37I44Y+4F8I+64JTD" alt="">`,
        alt: "アメフリ　大バナー",
      },
    ],
    smallImage: [
      {
        html: `<a href="https://px.a8.net/svt/ejp?a8mat=45I5TI+37I44Y+4F8I+639IP" rel="nofollow">
              <img border="0" width="300" height="250" alt="" src="https://www20.a8.net/svt/bgt?aid=251110134194&wid=001&eno=01&mid=s00000020637001023000&mc=1"></a>
              <img border="0" width="1" height="1" src="https://www17.a8.net/0.gif?a8mat=45I5TI+37I44Y+4F8I+639IP" alt="">`,
        alt: "アメフリ　小バナー",
      },
    ],
    affiliateContent: [
      "「アメフリ」は旧i2iポイントから続く、高還元案件に強いポイ活サイト！",
      "無料会員登録、ショッピング、クレカ発行、口座開設、アプリ利用などでポイントが貯まり、現金・ギフト券・電子マネー・マイルなどに交換可能",
      "大手サイト比較で最大級還元を目指す「ベストポイント」企画や、ログイン・ガチャ・キャンペーンでコツコツ貯めやすいのが魅力です",
    ],
    affiliateHighlights: [
      "旧i2iポイント時代から続く実績あるポイントサイト",
      "「ベストポイント」で他社よりお得な高還元案件をチェックできる",
      "ログインやガチャなど毎日参加型コンテンツでポイントが貯まりやすい",
      "現金・ギフト券・電子マネーなど幅広い交換先に対応",
    ...
    // カスタムテキスト（サービス詳細ページ用）
    topCtaMessage:
      "今なら新規登録だけで、ボーナスポイントが狙えるキャンペーン実施中！登録直後から、普段のネット利用がお得になる！",
    topCtaSupplement:
      "キャンペーン内容やポイント付与タイミングは案件ごとに変わるから、申し込む前に公式ページの最新条件を確認しておくと安心！",
    recommendedFor: [
      "楽天市場やYahoo!ショッピングをよく使う人で、買い物前のひと手間でポイントをしっかり増やしたい！",
      "複数のポイントサイトを使い分けるより、メイン1つに絞ってシンプルに貯めたい！",
      "ポイ活が初めてだから、まずは定番の安心サイトからスタートしたい！",
    ],
    precautions: [
      "ポイント交換には最低交換額の設定あり少額利用だけだと、交換まで時間がかかる場合も",
      "ポイント付与の条件や反映スピードは案件ごとに違うから、申し込み前に案件詳細ページで条件を確認しておくのがおすすめ",
      "退会や会員情報の変更をする時は、保有ポイントや交換申請中のポイントがどうなるか、事前に確認してから手続きを",
    ],
    bottomCtaMessage:
      "ここまで読んで「使ってみようかな」と思ったら、まずは無料登録して、どんな案件があるかのぞいてみよう！",
  },
  {
    id: "poi-2",
    name: "ワラウ",
    ...
    affiliateContent: [
      ...
      "約3,000以上の広告利用でポイントが貯まるサービスを掲載中ショッピングやサービス申し込みでガッツリ貯まります",
      "その他にもゲームや雑誌を読んだり、アンケートに答えたりと、毎日ポイントを貯めるチャンスが盛りだくさん貯めたポイントは1ポイント＝1円相当で、Tポイントなどの共通ポイントや電子マネー、ギフト券、銀行振込など30種類以上の交換先に交換可能！",
    ],
    affiliateHighlights: [
    ...
    //     "キャンペーン内容・対象案件は時期により変動詳細は紹介ページで確認",
    //   ],
    // },
  ...
  },
  {
    ...
    affiliateLinks: [
      {
        label: "ハピタス",
        url: "https://px.a8.net/svt/ejp?a8mat=45I5TH+6RIB76+1LP8+CALN5",
      },
    ],
    bigImage: [
      {
        html: `<a href="https://px.a8.net/svt/ejp?a8mat=45I5TH+6RIB76+1LP8+CALN5" rel="nofollow">
              <img border="0" width="300" height="250" alt="" src="https://www21.a8.net/svt/bgt?aid=251110133409&wid=001&eno=01&mid=s00000007478002065000&mc=1"></a>
              <img border="0" width="1" height="1" src="https://www15.a8.net/0.gif?a8mat=45I5TH+6RIB76+1LP8+CALN5" alt="">`,
        alt: "ハピタス 大バナー",
      },
    ],
    smallImage: [
      {
        html: `<a href="https://px.a8.net/svt/ejp?a8mat=45I5TH+6RIB76+1LP8+C7LM9" rel="nofollow">
              <img border="0" width="100" height="100" alt="" src="https://www29.a8.net/svt/bgt?aid=251110133409&wid=001&eno=01&mid=s00000007478002051000&mc=1"></a>
              <img border="0" width="1" height="1" src="https://www13.a8.net/0.gif?a8mat=45I5TH+6RIB76+1LP8+C7LM9" alt="">`,
        alt: "ハピタス 小バナー",
      },
    ],
    affiliateContent: [
      "「ハピタス」は“大手ショップ案件が超充実”なド定番ポイントサイト！",
      "楽天市場やYahoo!ショッピングなど、普段のネットショッピングをハピタス経由にするだけでポイントが貯まり、1ポイント＝1円で現金や各種ギフト券に交換OK",
      "高水準の還元率に加え、「お買い物あんしん保証」でポイント取りこぼし時もサポートしてくれる安心設計です",
    ],
    affiliateHighlights: [
      "大手通販・サービス案件が豊富で“メインサイト”として使いやすい",
      "高水準の還元率で1サイト完結のポイ活にも向いている",
      "1P=1円のわかりやすいレート＆少額から交換可能",
      "「お買い物あんしん保証」でポイント未付与時もサポート",
      "運営実績が長く、利用者からの信頼も高い定番サイト",
    ],
  ...
  },
  {
    ...
    smallImage: [
      {
        html: `<a href="https://pc.moppy.jp/entry/invite.php?invite=sNmEe1d9&type=service"><img decoding="async" loading="lazy" src="https://img.moppy.jp/pub/pc/friend/144x144-2.jpg" alt="賢く貯めるならモッピー1P=1円で交換先も多数！" width="144" height="144"></a>`,
        alt: "モッピー 小バナー",
      },
    ],
    affiliateContent: [
      "「モッピー」は会員数国内最大級、稼ぎやすさで人気のポイ活サイト！",
      "ネットショッピング、クレカ・銀行・FX口座開設、アプリ、レシート投稿など案件が豊富で、1ポイント＝1円相当でシンプル",
      "高還元案件や大型キャンペーン、50種類以上の交換先が揃っていて、“ガッツリ派”も“コツコツ派”も満足の万能サイトです",
    ],
    affiliateHighlights: [
      "会員数1,000万人超えの国内最大級ポイ活サービス",
      "高還元案件＆期間限定キャンペーンが常時充実",
      "現金・ギフト券・共通ポイント・電子マネーなど交換先が超豊富",
      "スマホアプリ対応でスキマ時間にサクッと稼げる",
      "プライバシーマーク取得など安全性にも配慮された運営",
    ],
  ...
  },
  {
    ...
    affiliateContent: [
      ...
      "貯めたポイントは「2ポイント＝1円」換算で、現金・ギフト券・電子マネー・共通ポイントなど多彩な交換先に交換可能高還元案件と毎日参加型コンテンツで、初心者から上級者まで使いやすいサービスです",
    ],
    affiliateHighlights: [
