...
<img border="0" width="1" height="1" src="https://www18.a8.net/0.gif?a8mat=45I7DK+5HNXMA+5PLE+5YZ75" alt="">`,
    ...
    // カスタムテキスト（サービス詳細ページ用）
    topCtaMessage: "今ならログインボーナスやクーポンなどで、初回からオリパを回しやすいお得な環境が整っています。",
    topCtaSupplement: "キャンペーン内容や当選カードの封入内容は時期によって変わるため、購入前に必ず公式サイトの最新情報や商品ページの説明を確認してください。",
    recommendedFor: [
      "オリパやトレカのガチャをワクワクしながら楽しみたい人",
      "高還元や厚封入のオリパで、「引ける感」が強いガチャを回したい人",
      "当選報告や封入内容がしっかりしている、安心感のあるサイトで遊びたい人",
    ],
    precautions: [
      "オリパはハズレが出る可能性もあり、必ずしも購入金額以上のカードが当たるわけではありません。",
      "当選確率や封入内容は企画ごとに異なるので、購入前に商品ページの説明や注意書きを必ず確認してください。",
      "使いすぎを防ぐために、あらかじめ1回あたり・1日あたりの予算を決めて、その範囲内で楽しむことをおすすめします。",
    ],
    bottomCtaMessage: "ここまで読んで「一度は試してみたい」と感じたら、無理のない金額から少額のオリパを回して、サイトの雰囲気をチェックしてみてください。",
  },
  {
    id: "oripa-2",
    name: "オリくじ（オンラインオリパ）",
