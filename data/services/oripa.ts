...
<img border="0" width="1" height="1" src="https://www18.a8.net/0.gif?a8mat=45I7DK+5HNXMA+5PLE+5YZ75" alt="">`,
    ...
    // カスタムテキスト（サービス詳細ページ用）
    topCtaMessage:
      "今ならログボやクーポンで、初回からオリパを回しやすいお得な環境が整ってる！",
    topCtaSupplement:
      "キャンペーン内容や当選カードの封入内容はタイミングで変わるから、購入前に公式サイトや商品ページで最新情報を確認しておくと安心！",
    recommendedFor: [
    ...
    precautions: [
      "オリパはハズレもあるから、必ずプラスになるわけじゃない過度な期待は禁物",
      "当選確率や封入内容は企画ごとに違うから、購入前に商品ページの説明や注意書きを確認しておくのがおすすめ",
      "使いすぎ防止のために、1回・1日あたりの上限を決めて、その範囲内で楽しむスタイルが◎",
    ],
    bottomCtaMessage:
      "ここまで読んで「試してみたいな」と思ったら、まずは無理のない金額で少額オリパを回して、サイトの雰囲気をチェックしてみよう！",
  },
  {
    id: "oripa-2",
    name: "オリくじ（オンラインオリパ）",
